...
* press the `O` key to observe the presentation's slides
...
video::http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4[ options="autoplay"]
